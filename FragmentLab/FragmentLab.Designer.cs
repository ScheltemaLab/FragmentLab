namespace FragmentLab
{
	partial class FragmentLab
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FragmentLab));
			...
			this.PeptideColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.ModificationsColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.ChargeColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.MzColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.FragmentationColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.RetentionTimeColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.RawFileColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.MinScanColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.MaxScanColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.RetentionLengthColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.FragmentationEnergyColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.DescriptionColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.ProteinsColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.IntensityColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.ModProbColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.ScoreColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			this.DeltaScoreColumn = ((HeckLib.visualization.objectlistview.CidOLVColumn)(new HeckLib.visualization.objectlistview.CidOLVColumn()));
			...
			((System.ComponentModel.ISupportInitialize)(this.PsmBrowser)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.splitcontainerGraphs)).BeginInit();
			...
			// 
			this.splitContainer2.Panel1.Controls.Add(this.propertiesSettings);
			// 
			...
			this.PsmBrowser.View = System.Windows.Forms.View.Details;
			// 
			// PeptideColumn
			// 
			...
			// MinScanColumn
			// 
			this.MinScanColumn.Text = "minScan";
			// 
			// MaxScanColumn
			// 
			this.MaxScanColumn.DisplayIndex = 7;
			...
			// 
			this.FragmentationEnergyColumn.DisplayIndex = 9;
			this.FragmentationEnergyColumn.IsVisible = false;
			this.FragmentationEnergyColumn.Text = "FragmentationEnergy";
			// 
			// DescriptionColumn
			// 
			this.DescriptionColumn.DisplayIndex = 5;
			...
			this.IntensityColumn.IsVisible = false;
			this.IntensityColumn.Text = "Intensity";
			// 
			// ModProbColumn
			// 
			...
			// DeltaScoreColumn
			// 
			this.DeltaScoreColumn.DisplayIndex = 15;
			this.DeltaScoreColumn.IsVisible = false;
			this.DeltaScoreColumn.Text = "DeltaScore";
			// 
			...
			// 
			this.splitcontainerGraphs.Panel1.Controls.Add(this.ms2SpectrumGraph1);
			// 
			...
			// ms2SpectrumGraph1
			// 
			this.ms2SpectrumGraph1.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.ms2SpectrumGraph1.BreakArea = false;
			this.ms2SpectrumGraph1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.ms2SpectrumGraph1.Location = new System.Drawing.Point(0, 0);
			...
			this.tableLayoutPanel2.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 29.20269F));
			this.tableLayoutPanel2.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 70.79731F));
			this.tableLayoutPanel2.Controls.Add(this.ms2FragmentTable1, 1, 0);
			this.tableLayoutPanel2.Controls.Add(this.boxPlot1, 0, 0);
			...
			// boxPlot1
			// 
			this.boxPlot1.BackColor = System.Drawing.SystemColors.Window;
			this.boxPlot1.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.boxPlot1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.boxPlot1.Location = new System.Drawing.Point(0, 3);
			this.boxPlot1.Margin = new System.Windows.Forms.Padding(0, 3, 3, 0);
			...
			// 
			this.mscoreToolStripMenuItem.Name = "mscoreToolStripMenuItem";
			this.mscoreToolStripMenuItem.Size = new System.Drawing.Size(32, 19);
			// 
			// tableLayoutPanel1
			// 
			...
			this.Name = "FragmentLab";
			this.Text = "Fragment Lab";
			...
			((System.ComponentModel.ISupportInitialize)(this.PsmBrowser)).EndInit();
		...
		private System.Windows.Forms.PropertyGrid propertiesSettings;
		...
		private HeckLib.visualization.objectlistview.CidOLVColumn ChargeColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn MzColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn FragmentationColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn RetentionTimeColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn RawFileColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn DescriptionColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn MinScanColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn MaxScanColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn RetentionLengthColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn FragmentationEnergyColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn ProteinsColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn PeptideColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn IntensityColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn ModProbColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn ScoreColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn DeltaScoreColumn;
		private HeckLib.visualization.objectlistview.CidOLVColumn ModificationsColumn;
		private System.Windows.Forms.ToolStripSeparator toolStripSeparator2;
		private System.Windows.Forms.SplitContainer splitcontainerGraphs;
		private System.Windows.Forms.TableLayoutPanel tableLayoutPanel2;
		private HeckLib.visualization.Ms2FragmentTable ms2FragmentTable1;
